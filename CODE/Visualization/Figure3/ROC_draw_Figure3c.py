...
output_path = r"/results/roc_TERT_mutation_new.png"
...
# Assume the file has two columns: 'true_labels' and 'pred_probs', which are the true labels and predicted probabilities
# Compute FPR, TPR, and AUC for each fold
...
# Thicken tick marks as well (optional)
