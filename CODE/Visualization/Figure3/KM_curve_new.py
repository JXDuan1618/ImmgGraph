...
####################################################################################
train_df = pd.read_csv(r'E:\Multi-omic Immunity\GCN_immune\scripts\LGG\picture\figure_3_A\prognosis\KM_curve\correct_Discovery\fold_4_train_risk_ZZU.csv')
train_df["split"] = "train"
train_df = train_df.rename(
    columns={'Risk': 'risk_score', 'Time': 'overall_survival', "Event": "vital_status"})
###############################################################################
val_df = pd.read_csv(r'E:\Multi-omic Immunity\GCN_immune\scripts\LGG\picture\figure_3_A\prognosis\KM_curve\correct_Discovery\fold_4_val_risk_ZZU.csv')
val_df["split"] = "valid"
...
# ----------------------------------------------------------
train_output_path = r"E:\Multi-omic Immunity\GCN_immune\scripts\LGG\picture\figure_3_A\prognosis\KM_curve\correct_Discovery\fold_4_train_risk_ZZU_os_hhh.csv"
val_output_path   = r"E:\Multi-omic Immunity\GCN_immune\scripts\LGG\picture\figure_3_A\prognosis\KM_curve\correct_Discovery\fold_4_val_risk_ZZU_hhh.csv"
...
ax1.set_title('PFS', fontsize=60, pad=30)
...
plt.savefig(r'E:\Multi-omic Immunity\GCN_immune\scripts\LGG\picture\figure_3_A\prognosis\KM_curve\correct_Discovery\kaplan_meier_train_pfs_ZZU_train.png', bbox_inches='tight')
#plt.show()
...
ax2.set_title('PFS', fontsize=60, pad=30)
...
plt.subplots_adjust(bottom=0.1)
plt.savefig(r'E:\Multi-omic Immunity\GCN_immune\scripts\LGG\picture\figure_3_A\prognosis\KM_curve\correct_Discovery\kaplan_meier_valid_pfs_ZZU_valid.png', bbox_inches='tight')
#plt.show()
